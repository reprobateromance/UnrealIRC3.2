...
IRCDLIBS=-lcrypt -lnsl  -ldl ../extras/regexp/lib/libtre.a -L../extras/c-ares/lib /root/Unreal3.2/extras/c-ares/lib/libcares.a -lrt
CRYPTOLIB=
OPENSSLINCLUDES=

XCFLAGS=-I/root/Unreal3.2/extras/regexp/include -I/root/Unreal3.2/extras/c-ares/include -pipe -g -O2 -funsigned-char -fno-strict-aliasing -Wno-pointer-sign -export-dynamic
#
...
SHELL=/bin/sh
SUBDIRS=src
BINDIR=/root/Unreal3.2/src/ircd
